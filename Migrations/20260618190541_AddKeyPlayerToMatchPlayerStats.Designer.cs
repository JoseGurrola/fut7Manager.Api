...
namespace fut7Manager.Api.Migrations
{
    ...
    [Migration("20260618190541_AddKeyPlayerToMatchPlayerStats")]
    partial class AddKeyPlayerToMatchPlayerStats
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("fut7Manager.Api.Models.League", b =>
                {
                    ...
                    b.Property<int?>("TotalQualifiedTeams")
                        .HasColumnType("int");

                    b.Property<bool>("UsePenaltyShootoutPoints")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("fut7Manager.Api.Models.MatchPlayerStat", b =>
                {
                    ...
                    b.HasOne("fut7Manager.Api.Models.Player", "Player")
                        .WithMany()
